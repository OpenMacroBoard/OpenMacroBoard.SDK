...
namespace OpenMacroBoard.Tests
{
    public class KeyBitmapTests
    {
        ...
        {
            Action act_zero = () => KeyBitmap.Create.FromNoOverhangBgr24Array(0, 1, null);
            Action act_negative = () => KeyBitmap.Create.FromNoOverhangBgr24Array(-1, 1, null);
        ...
        {
            Action act_zero = () => KeyBitmap.Create.FromNoOverhangBgr24Array(1, 0, null);
            Action act_negative = () => KeyBitmap.Create.FromNoOverhangBgr24Array(1, -1, null);
        ...
        {
            Action act_correctParams = () => KeyBitmap.Create.FromNoOverhangBgr24Array(2, 2, new byte[12]);
            Action act_incorrectParams = () => KeyBitmap.Create.FromNoOverhangBgr24Array(3, 3, new byte[5]);
        ...
        {
            var key1 = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 4, null);
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(3, 4, null);
            var key3 = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 4, null);
        ...
        {
            var key1 = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 4, null);
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 3, null);
            var key3 = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 4, null);
        ...
        {
            var key = KeyBitmap.Create.FromNoOverhangBgr24Array(4, 4, null);
        ...
        {
            var key1 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, null);
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, new byte[3]);
        ...
        {
            var key1 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, new byte[3]);

            var key2Data = new byte[3] { 1, 2, 3 };
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, key2Data);
        ...
        public void AllEqualityMethodsBehaveTheSameWay()
        {
            ...
            var key2Data = new byte[3] { 1, 2, 3 };
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, key2Data);
            var key3 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, new byte[3]);
        ...
        public void HashCodesDontMatchEasilyForDifferentObjects()
        {
            ...
            var key2Data = new byte[3] { 1, 2, 3 };
            var key2 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, key2Data);
            var key3 = KeyBitmap.Create.FromNoOverhangBgr24Array(1, 1, null);
            var key4 = KeyBitmap.Create.FromNoOverhangBgr24Array(100, 100, new byte[100 * 100 * 3]);
